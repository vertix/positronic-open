...
@cfn.config(width=1920, height=1080, fps=30, pixel_format="MJPG", image_mapping=None)
...
@cfn.config(fps=60, image_mapping=None)
...
@cfn.config(camera_id=0, resolution=(640, 480), fps=30, image_mapping=None)
...
merged = cfn.Config(merge_on_pulse, cameras={'left': arducam_left, 'right': arducam_right}, fps=30)
